...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  H:\智能车程序2018\三轮比赛\7.29-sc\lib\C\KEA128_uart.c
//    Command line =  
//        H:\智能车程序2018\三轮比赛\7.29-sc\lib\C\KEA128_uart.c -D IAR -D
...
//    List file    =  
//        H:\智能车程序2018\三轮比赛\7.29-sc\iar\KEA_128_FLASH\List\KEA128_uart.s
//
///////////////////////////////////////////////////////////////////////////////
...
// H:\智能车程序2018\三轮比赛\7.29-sc\lib\C\KEA128_uart.c
//    1 /*********************************************************************************************************************
//    2  * COPYRIGHT NOTICE
...
NVIC_DisableIRQ:
        ...
        LSRS     R2,R2,#+27
        LSLS     R1,R1,R2
        LDR      R2,??DataTable9_1  ;; 0xe000e180
        STR      R1,[R2, #+0]
        BX       LR               ;; return
//   22 
//   23 
...
??uart_mux_0:
        LDR      R1,??DataTable9_2  ;; 0x40048014
        LDR      R1,[R1, #+0]
        MOVS     R2,#+128
...
//   40             SIM->PINSEL &= ~SIM_PINSEL_UART0PS_MASK;
        ...
        MOVS     R2,#+128
        BICS     R1,R1,R2
        LDR      R2,??DataTable9_3  ;; 0x4004800c
        STR      R1,[R2, #+0]
//   41         }
//   42         else
//   43         {
...
//   56             SIM->PINSEL1 |= SIM_PINSEL1_UART1PS_MASK;
        LDR      R1,??DataTable9_4  ;; 0x40048010
        LDR      R1,[R1, #+0]
        MOVS     R2,#+128
        LSLS     R2,R2,#+5        ;; #+4096
        ORRS     R2,R2,R1
...
//   64             SIM->PINSEL1 &= ~SIM_PINSEL1_UART2PS_MASK;
        LDR      R1,??DataTable9_4  ;; 0x40048010
        LDR      R1,[R1, #+0]
        LDR      R2,??DataTable9_5  ;; 0xffffdfff
        ANDS     R2,R2,R1
        LDR      R1,??DataTable9_4  ;; 0x40048010
        STR      R2,[R1, #+0]
//   65         }
