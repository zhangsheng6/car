...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  H:\智能车程序2018\三轮比赛\7.29-sc\device\C\ftm.c
//    Command line =  
//        H:\智能车程序2018\三轮比赛\7.29-sc\device\C\ftm.c -D IAR -D
...
//    List file    =  
//        H:\智能车程序2018\三轮比赛\7.29-sc\iar\KEA_128_FLASH\List\ftm.s
//
///////////////////////////////////////////////////////////////////////////////
...
// H:\智能车程序2018\三轮比赛\7.29-sc\device\C\ftm.c
//    1 /**
//    2   ******************************************************************************
//    3   * COPYRIGHT NOTICE
...
??FTM_PwmMux_4:
        LDR      R2,??DataTable2_1  ;; 0x4004800c
        LDR      R2,[R2, #+0]
        LDR      R3,??DataTable2_2  ;; 0xfffffeff
        ANDS     R3,R3,R2
        LDR      R2,??DataTable2_1  ;; 0x4004800c
        STR      R3,[R2, #+0]
//   54             }
...
??FTM_PwmMux_5:
        LDR      R2,??DataTable2_1  ;; 0x4004800c
        LDR      R2,[R2, #+0]
        LDR      R3,??DataTable2_3  ;; 0xfffffdff
        ANDS     R3,R3,R2
        LDR      R2,??DataTable2_1  ;; 0x4004800c
        STR      R3,[R2, #+0]
//   64             }
...
??FTM_PwmMux_10:
        LDR      R2,??DataTable2_1  ;; 0x4004800c
        LDR      R2,[R2, #+0]
        LDR      R3,??DataTable2_4  ;; 0xfffff7ff
        ANDS     R3,R3,R2
        LDR      R2,??DataTable2_1  ;; 0x4004800c
        STR      R3,[R2, #+0]
//   94             }
...
??FTM_PwmMux_13:
        LDR      R2,??DataTable5  ;; 0x40048010
        LDR      R2,[R2, #+0]
        MOVS     R3,#+3
        BICS     R2,R2,R3
        LDR      R3,??DataTable5  ;; 0x40048010
        STR      R2,[R3, #+0]
...
??FTM_SpeedMux_0:
        LDR      R0,??DataTable6_3  ;; 0x40048014
        LDR      R0,[R0, #+0]
        MOVS     R1,#+32
        ORRS     R1,R1,R0
        LDR      R0,??DataTable6_3  ;; 0x40048014
...
//  335             SIM->PINSEL &= ~SIM_PINSEL_FTM0CLKPS_MASK;
        LDR      R0,??DataTable6_4  ;; 0x4004800c
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable6_5  ;; 0xfcffffff
        ANDS     R1,R1,R0
        LDR      R0,??DataTable6_4  ;; 0x4004800c
        STR      R1,[R0, #+0]
...
//  358             SIM->PINSEL &= ~SIM_PINSEL_FTM1CLKPS_MASK;      //清除外部时钟引脚选择
        LDR      R0,??DataTable6_4  ;; 0x4004800c
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable6_6  ;; 0xf3ffffff
        ANDS     R1,R1,R0
        LDR      R0,??DataTable6_4  ;; 0x4004800c
        STR      R1,[R0, #+0]
...
//  381             SIM->PINSEL &= ~SIM_PINSEL_FTM2CLKPS_MASK;      //清除外部时钟引脚选择
        LDR      R0,??DataTable6_4  ;; 0x4004800c
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable6_7  ;; 0xcfffffff
        ANDS     R1,R1,R0
        LDR      R0,??DataTable6_4  ;; 0x4004800c
        STR      R1,[R0, #+0]
//  382             FTM2->CNTIN = 0;
        MOVS     R0,#+0
        LDR      R1,??DataTable6_8  ;; 0x4003a04c
        STR      R0,[R1, #+0]
...
//  386                 SIM->PINSEL |= SIM_PINSEL_FTM2CLKPS(0);     //选择外部时钟输入引脚 A5
        LDR      R0,??DataTable6_4  ;; 0x4004800c
        LDR      R0,[R0, #+0]
        LDR      R1,??DataTable6_4  ;; 0x4004800c
        STR      R0,[R1, #+0]
//  387             }
//  388 
