...
//    List file    =  
//        H:\智能车程序2018\三轮比赛\7.29-sc\iar\KEA_128_FLASH\List\oled.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  729             OLED_WrDat(menuNum[4][x]);
        LDR      R0,??OLED_MenuFlicker_20+0x4
        UXTB     R4,R4
        ADDS     R0,R0,R4
        LDRB     R0,[R0, #+28]
        BL       OLED_WrDat
...
??OLED_DisplayFloat_2:
        UXTB     R7,R7
        CMP      R7,#+0
        BEQ      ??OLED_DisplayFloat_3
// 1019     {
// 1020         len --;
        SUBS     R7,R7,#+1
// 1021         decimals *= 10;
        LDR      R0,??DataTable11_4  ;; 0x41200000
        MOVS     R1,R4
        BL       __aeabi_fmul
        MOVS     R4,R0
