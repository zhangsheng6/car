...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  H:\智能车程序2018\三轮比赛\7.29-sc\lib\C\KEA128_adc.c
//    Command line =  
//        H:\智能车程序2018\三轮比赛\7.29-sc\lib\C\KEA128_adc.c -D IAR -D
...
//    List file    =  
//        H:\智能车程序2018\三轮比赛\7.29-sc\iar\KEA_128_FLASH\List\KEA128_adc.s
//
///////////////////////////////////////////////////////////////////////////////
...
// H:\智能车程序2018\三轮比赛\7.29-sc\lib\C\KEA128_adc.c
//    1 /*********************************************************************************************************************
//    2  * COPYRIGHT NOTICE
...
//   56                 );
        ...
        MOVS     R4,#+12
        ANDS     R4,R4,R3
        LDR      R3,??DataTable2_2  ;; 0x4003b008
        STR      R4,[R3, #+0]
//   57         
//   58     
//   59     ADC->SC2 = ADC_SC2_REFSEL(0);           //基准电压选择
        MOVS     R3,#+0
        LDR      R4,??DataTable2_3  ;; 0x4003b004
        STR      R3,[R4, #+0]
//   60 
//   61     ADC->SC1 = ADC_SC1_ADCH(adcn_ch);       //启动转换
        UXTB     R2,R2
        LSLS     R3,R2,#+27       ;; ZeroExtS R3,R2,#+27,#+27
        LSRS     R3,R3,#+27
        LDR      R4,??DataTable2_4  ;; 0x4003b000
        STR      R3,[R4, #+0]
//   62     
//   63     while(!(ADC->SC1 & ADC_SC1_COCO_MASK)); //等待转换完成
??adc_once_0:
        LDR      R3,??DataTable2_4  ;; 0x4003b000
        LDR      R3,[R3, #+0]
        LSLS     R3,R3,#+24
        BPL      ??adc_once_0
//   64     result = ADC->R;
        LDR      R3,??DataTable2_5  ;; 0x4003b010
        LDR      R3,[R3, #+0]
        MOVS     R0,R3
