...
#include "allHead.h"
/*参数*/
extern int akmj_z,akmj_w;//w20
extern int BB_Z,BB_W,BB_H;
extern int BB_P_Z,BB_P_F,BB_P_W;

extern int     Circle_Count6_Max;//下次圆环间隔时间1S1000
extern int   Circle_Inductor_M1,//进圆环双线值
         Circle_Inductor_M2,//测转弯值
         Circle_Inductor_M3,//转弯值
         Circle_Inductor_LR1;
 extern int Chazhi_Change,Chazhi_Change2;


extern int   Circle_Chazhi;
...
#define M 50
extern int z,man;
extern int  iic_error,iic_error_counter;
extern int  WindingRoad_Flag;
extern int zs_car;
//----------------------------陀螺仪--------------------------------------------
...
extern float gyr_angle_speed,gyr_angle_speed_up,//陀螺仪角速度
 ...
 extern float AD_hall,Stop_Flag;
...
extern float  min_v[5] ;  //电感标定 采集值      ？？？？待测？？？？
...
extern float speed_set_temp_L,speed_set_temp_R;
...
/*--------------------速度设定，测速变量--------------------------------------*/
extern float speed_set_L,speed_set_R,speed_set_L_W,speed_set_R_W,speed_set_L_2,speed_set_R_2;
extern float speed_L ,speed_R ,speed_car,speed_point;//测速左,车整体速度
...
/*---------------------------------方向环-------------------------------------*/
extern float Speed_P_D,Speed_P_D_Temp,//方向环P选择
              Speed_I_D,//方向环I选择
              Speed_D_D,//方向环D选择80 
...
extern float Direction_Control_Output_R ;
 ...
 extern float Speed_Control_Output_R,Control_Output_L,Control_Output_R;//        电机PWM输出
//速度控
...
extern float Motor_Out_L,Motor_Out_R,Motor_Out_R_Temp;
/*********************电机输出变量END***************************************/
