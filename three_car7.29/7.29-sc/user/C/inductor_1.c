...
//            ad_valu[4][i] = ADC_Once(ADC_5,adc12bit);  //中2 通道
                 ...
                 ad_valu[0][i] = ADC_Once(ADC_5,adc12bit);  //左  通道
            ad_valu[1][i] = ADC_Once(ADC_4,adc12bit);  //中  通道
            ad_valu[2][i] = ADC_Once(ADC_3,adc12bit);  //右  通道
            ad_valu[3][i] = ADC_Once(ADC_2,adc12bit);  //中1 通道
            ad_valu[4][i] = ADC_Once(ADC_1,adc12bit);  //中2 通道
