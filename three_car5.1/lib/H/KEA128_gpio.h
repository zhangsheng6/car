...
void    GpioInit(PTX_n ptx_n, GPIO_MOD ddr, uint8 dat);//初始化gpio
void    gpio_ddr(PTX_n ptx_n, GPIO_MOD ddr);            //设置引脚方向
uint8   GpioGet(PTX_n ptx_n);                          //获取引脚状态
void    GpioSet(PTX_n ptx_n, uint8 dat);               //设置引脚状态
void    GpioTurn(PTX_n ptx_n);                         //翻转引脚状态
