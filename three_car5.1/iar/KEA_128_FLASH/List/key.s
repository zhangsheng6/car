...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  H:\智能车程序2018\电磁三轮——ZS\5.1\device\C\key.c
//    Command line =  
//        H:\智能车程序2018\电磁三轮——ZS\5.1\device\C\key.c -D IAR -D
...
//    List file    =  
//        H:\智能车程序2018\电磁三轮——ZS\5.1\iar\KEA_128_FLASH\List\key.s
//
///////////////////////////////////////////////////////////////////////////////
...
// H:\智能车程序2018\电磁三轮——ZS\5.1\device\C\key.c
//    1 /**
//    2   ******************************************************************************
//    3   * COPYRIGHT NOTICE
...
??KEY_ParaMenu_31:
        LDR      R0,??KEY_ParaMenu_6+0xC
        LDR      R1,[R0, #+0]
        LDR      R0,??KEY_ParaMenu_42+0x4  ;; 0xc1200000
        BL       __aeabi_fadd
        LDR      R1,??KEY_ParaMenu_6+0xC
        STR      R0,[R1, #+0]
//  276             break;
...
??KEY_ParaMenu_39:
        ...
        BL       __aeabi_f2d
        MOVS     R2,#+0
        LDR      R3,??KEY_ParaMenu_44  ;; 0xbfe00000
        BL       __aeabi_dadd
        BL       __aeabi_d2f
        LDR      R1,??KEY_ParaMenu_6+0x30
        STR      R0,[R1, #+0]
...
??KEY_ParaMenu_40:
        ...
        SUBS     R0,R0,#+8
        MOVS     R0,#+0
        LDR      R1,??KEY_ParaMenu_45  ;; 0xc0240000
        BL       __aeabi_dadd
        LDR      R2,??KEY_ParaMenu_24+0x4
        STM      R2!,{R0,R1}
        SUBS     R2,R2,#+8
...
??KEY_ParaMenu_46:
        MOVS     R0,#+0
        LDR      R1,??KEY_ParaMenu_48
        STRB     R0,[R1, #+0]
//  329         switch (menuSelect)
??KEY_ParaMenu_47:
        LDR      R0,??KEY_ParaMenu_48+0x4
        LDRB     R0,[R0, #+0]
        CMP      R0,#+1
        BEQ      ??KEY_ParaMenu_49
        BCS      .+4
...
//  488 OLED_DisplayFloat(1+6*3+1, 2,Speed_P_D, 1);//OLED显示 float  
...
// 2 670 bytes in section .text
// 
// 2 670 bytes of CODE memory
