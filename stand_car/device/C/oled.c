...
void OLED_Clear(void)
{
    ...
    for (y=0; y<8; y++)
    {
        ...
        OLED_WrCmd(0x02);
#else
        OLED_WrCmd(0x00);  //设置显示位置—列低地址,偏移了1列
#endif       
...
void OLED_Menu()
{
  ...
  for (i=0; i<10; i++)
  {
      ...
      case 9:/* 各个菜单预先显示,可屏蔽 */
          OLED_DisplaytinyStr(1, 2, "P_a"); //菜单1内容显示
          OLED_DisplaytinyStr(68, 2, "D_a");//菜单2内容显示
          OLED_DisplaytinyStr(1, 6, "I_S"); //菜单3第一功能显示
          OLED_DisplaytinyStr(1, 7, "P_S");   //菜单3第二功能显示
            break;
