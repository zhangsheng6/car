...
//    Endian       =  little
//    Source file  =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\lib\C\KEA128_flash.c
//    Command line =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\lib\C\KEA128_flash.c -D IAR
...
//        -Ol
//    List file    =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\iar\KEA_128_FLASH\List\KEA128_flash.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  109     FTF->FCCOBIX = 0;
        MOVS     R1,#+0
        LDR      R2,??DataTable3_6  ;; 0x40020001
        STRB     R1,[R2, #+0]
//  110     FTF->FCCOBHI = ERASE_FLASH_SECTOR;
        MOVS     R1,#+10
        LDR      R2,??DataTable3_7  ;; 0x40020009
        STRB     R1,[R2, #+0]
//  111     FTF->FCCOBLO = addr>>16;
        MOVS     R1,R0
        LSRS     R1,R1,#+16
        LDR      R2,??DataTable3_8  ;; 0x40020008
        STRB     R1,[R2, #+0]
//  112 
//  113     FTF->FCCOBIX = 1;
        MOVS     R1,#+1
