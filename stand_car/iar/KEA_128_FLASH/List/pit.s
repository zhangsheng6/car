...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\device\C\pit.c
//    Command line =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\device\C\pit.c -D IAR -D
...
//        -Ol
//    List file    =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\iar\KEA_128_FLASH\List\pit.s
//
///////////////////////////////////////////////////////////////////////////////
...
// I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\device\C\pit.c
//    1 /**
//    2   ******************************************************************************
//    3   * COPYRIGHT NOTICE
...
NVIC_DisableIRQ:
        ...
        LSRS     R0,R0,#+27
        LSLS     R1,R1,R0
        LDR      R0,??DataTable4_1  ;; 0xe000e180
        STR      R1,[R0, #+0]
        BX       LR               ;; return
//   17 
//   18 /**
...
//   34 	SIM->SCGC       |= SIM_SCGC_PIT_MASK;       //使能PIT时钟
        LDR      R1,??DataTable4_3  ;; 0x40048014
        LDR      R1,[R1, #+0]
        MOVS     R2,#+2
        ORRS     R2,R2,R1
        LDR      R1,??DataTable4_3  ;; 0x40048014
...
//   36 	PIT->MCR        &= ~PIT_MCR_MDIS_MASK;      //必须在执行任何其他设置之前使能该字段
        ...
        MOVS     R2,#+2
        BICS     R1,R1,R2
        LDR      R2,??DataTable4_4  ;; 0x40037000
        STR      R1,[R2, #+0]
