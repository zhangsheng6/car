...
//    Endian       =  little
//    Source file  =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\lib\C\KEA128_irq.c
//    Command line =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\lib\C\KEA128_irq.c -D IAR -D
...
//        -Ol
//    List file    =  
//        I:\电磁程序-ZS\电磁直立-ZS\stand_ZS_9.28\iar\KEA_128_FLASH\List\KEA128_irq.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   58     SIM->SCGC |= SIM_SCGC_IRQ_MASK;     //开启IRQ时钟
        LDR      R0,??irq_init_0+0x4  ;; 0x40048014
        LDR      R0,[R0, #+0]
        MOVS     R1,#+128
...
//   65             );
        MOVS     R1,#+50
//   66     IRQ->SC = temp;
        LDR      R0,??irq_init_0+0x8  ;; 0x40031000
        STRB     R1,[R0, #+0]
//   67     
//   68 }
        BX       LR               ;; return
